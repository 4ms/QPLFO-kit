...
int main(void){
	...
	uint32_t tapout1_clk_time=0;
	uint8_t tapin1_up=0;
	uint8_t ping1_high=0;
	char running1=0,running2=0,running3=0,running4=0;

	uint32_t tapout2_clk_time=0;
	uint8_t tapin2_up=0;
	uint8_t ping2_high=0;

	uint32_t tapout3_clk_time=0;
	uint8_t tapin3_up=0;
	uint8_t ping3_high=0;

	uint32_t tapout4_clk_time=0;
	uint8_t tapin4_up=0;
